...
function hitTest(r1, r2) {
    ...
    hit = false;
    r1.hitW || (r1.hitW = r1.width);
    r1.hitH || (r1.hitH = r1.height);
    r2.hitW || (r2.hitW = r2.width);
    r2.hitH || (r2.hitH = r2.height);
    r1.centerX = r1.x + r1.hitW / 2;
    r1.centerY = r1.y + r1.hitH / 2;
    r2.centerX = r2.x + r2.hitW / 2;
    r2.centerY = r2.y + r2.hitH / 2;
    r1.halfWidth = r1.hitW / 2;
    r1.halfHeight = r1.hitH / 2;
    r2.halfWidth = r2.hitW / 2;
    r2.halfHeight = r2.hitH / 2;
